...
public class Registration extends javax.swing.JFrame {
    ...
    //Registered_Employees Reg = new Registered_Employees(); //экземпляр класса
      //Reg.SelectMed();
    ...
    public void SelectMed(){
        try{
            ...
            Registered_Employees.Registration_Tbl.setModel(DbUtils.resultSetToTableModel(Rs));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(RePass, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)))
    ...
    private void RegistrationBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrationBtnActionPerformed
         if (RegIdTxt.getText().isEmpty() || LoginTxt.getText().isEmpty() || Password.getText().isEmpty())
        {
            ...
            try{
                ...
                add.setInt(1, Integer.valueOf(RegIdTxt.getText()));
                add.setString(2, PositionCmbBox.getSelectedItem().toString());
                add.setString(3, NameCmbBox.getSelectedItem().toString());
                add.setString(4, LoginTxt.getText());
    ...
    private void PasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PasswordActionPerformed
        String simvol = Password.getText();
        Pattern PASSWORD_PATTERN = Pattern.compile("((?=.*[a-z])(?=.*\\d)(?=.*[A-Z])(?=.*[@#$%!]).{8,40})");
        Matcher matpassletter = PASSWORD_PATTERN.matcher(simvol);
        if(matpassletter.matches()==false)
        {
            JOptionPane.showMessageDialog(this, "Ваш пароль должен иметь следующий формат\n" + "Длина от 8 до 40 символов\n" +
            "Содержит хотя бы одну цифру.\n" +
            "Содержит хотя бы один символ нижнего регистра.\n" +
            "Содержит хотя бы один символ верхнего регистра.\n" +
            "Содержат хотя бы один специальный символ из [@ # $%! . ].");
        }

    }//GEN-LAST:event_PasswordActionPerformed

    private void RePassActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RePassActionPerformed
        /*if(Password.getText() == RePass.getText()){
            JOptionPane.showMessageDialog(this, "Повторный пароль введён верно");
        }
        else {
            JOptionPane.showMessageDialog(this, "Повторный пароль введён неверно");
        }*/
