...
public class Staff extends javax.swing.JFrame {
    ...
    */
    ...
    private void initComponents() {
        ...
        Print.setBackground(new java.awt.Color(102, 0, 0));
    ...
    private void SaveBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaveBtnMouseClicked
        if (PhoneTxt.getText().length() > 11){
                JOptionPane.showMessageDialog(this, "Число символов в поле 'Телефон' не должно превышать 11. \nПожалуйста, введите данные вновь, \nиспользуя при этом только цифры");
                PhoneTxt.setText("");
            }
    ...
    private void NameTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NameTxtActionPerformed
        ...
        Pattern hasSpecialChar = Pattern.compile("[a-zA-Z0-9 ]{1}");
        Matcher matlatletter = hasSpecialChar.matcher(simvol);
        if(matlatletter.matches()==false)
        {
            JOptionPane.showMessageDialog(this, "Пожалуйста, используйте только символы русского алфавита");
        }
    ...
    private void PhoneTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PhoneTxtActionPerformed
       if (PhoneTxt.getText().length() != 11){
                JOptionPane.showMessageDialog(this, "Число символов в поле 'Телефон' должно быть равно 11. \nПожалуйста, введите данные верно, \nиспользуя при этом только цифры");
                PhoneTxt.setText("");
            }
        Pattern patnumber = Pattern.compile("[0-9]{1}");
        Matcher matnumber = patnumber.matcher(PhoneTxt.getText());
         if(matnumber.matches()==false)
        {
            JOptionPane.showMessageDialog(this, "Недопустимые значения для данного поля");
        }
